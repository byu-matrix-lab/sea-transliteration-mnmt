...
class BartModel(BartPreTrainedModel):
    ...
    def forward(
        ...
        if encoder_outputs is None:
            encoder_outputs_orth = self.encoder(
                input_ids=input_ids,
                attention_mask=attention_mask,
                head_mask=head_mask,
                inputs_embeds=None,
            ...
            encoder_outputs_phon = self.encoder(
            ...
            # print("encoder_outputs_orth:", encoder_outputs_orth.last_hidden_state.shape, "encoder_outputs_phon:", encoder_outputs_phon.last_hidden_state.shape)
            # print("encoder_outputs_orth:", encoder_outputs_orth[0], "encoder_outputs_phon:", encoder_outputs_phon[0])
            # print(encoder_outputs_orth[0].shape, encoder_outputs_phon[0].shape)

            combined_last_hidden_state = encoder_outputs_orth[0] + encoder_outputs_phon[0]
            # combined_attention_mask = attention_mask & phonetic_attention_mask

            encoder_outputs = BaseModelOutput(
                last_hidden_state=combined_last_hidden_state,
                hidden_states=None, #encoder_outputs_orth.hidden_states, # TODO: Don't know if we should combine these as well
                attentions=None, #combined_attention_mask, #encoder_outputs_orth.attentions,
            )
        # If the user passed a tuple for encoder_outputs, we wrap it in a BaseModelOutput when return_dict=True
        elif return_dict and not isinstance(encoder_outputs, BaseModelOutput):
            # I got rid of this I hope it's fine.
            encoder_outputs = BaseModelOutput(
        ...
        decoder_outputs = self.decoder(
            ...
            encoder_attention_mask=attention_mask & phonetic_attention_mask, # Use combined attention mask
